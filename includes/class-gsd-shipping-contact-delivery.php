...
class GSD_Shipping_Contact_Delivery extends WC_Shipping_Method {
    ...
    public function __construct($instance_id = 0) {
        ...
        $this->method_title = __('Home delivery may be possible - please contact us.', 'garden-sheds-delivery');
    ...
    public function init_form_fields() {
        $this->instance_form_fields = array(
            ...
            'title' => array(
                ...
                'default' => __('Home delivery may be possible - please contact us.', 'garden-sheds-delivery'),
                'desc_tip' => true,
            ),
        );
    }
